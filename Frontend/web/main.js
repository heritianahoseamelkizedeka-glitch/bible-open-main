...
<<<<<<< HEAD
  ...
  en: {
    title: 'Bible Open — The Bible, open to everyone', description: 'Bible Open brings together simple tools to discover, understand and live the Bible.', brandLabel: 'Bible Open, home', bibleAlt: 'Real open Bible', languageLabel: 'Choose language', navApps: 'Our applications', heroEyebrow: 'A library that grows with you', heroTitle: 'The Bible,<br /><em>open to everyone.</em>', heroIntro: 'Explore Scripture, deepen your faith and test your knowledge with accessible tools designed for everyday use.', discover: 'Discover the applications', verse: 'Your word is a lamp to my feet and a light to my path.', verseRef: 'Psalm 119:105', ecosystem: 'The Bible Open ecosystem', appsTitle: 'One shared purpose,<br />seven ways forward.', appsIntro: 'Choose your path: learn, study, serve and help church life grow.', available: 'Available', quizKicker: 'Learn & play', quizDescription: 'Questions to discover the Bible differently, make progress and share a stimulating moment.', openQuiz: 'Open Bible Quiz', external: 'Open in an external browser', studyKicker: 'Read & explore', studyDescription: 'A complete space to read, annotate and study texts while nurturing personal reflection.', openStudy: 'Open Study Bible', communityKicker: 'Life together', communityTitle: 'Church<br />Community', communityDescription: 'A space for members, groups and the relationships that bring community to life.', openCommunity: 'Open Church Community', coreKicker: 'Lead the church', coreTitle: 'Church<br />Core', coreDescription: 'The central portal for coordinating church spaces, teams and services.', openCore: 'Open Church Core', communicationKicker: 'Share what matters', communicationTitle: 'Church<br />Communication', communicationDescription: 'Tools to inform, publish and keep the community connected every day.', openCommunication: 'Open Church Communication', stewardshipKicker: 'Care for resources', stewardshipTitle: 'Church<br />Stewardship', stewardshipDescription: 'A clear space to track resources and support the church mission.', openStewardship: 'Open Church Stewardship', pastoralKicker: 'Care for people', pastoralTitle: 'Pastoral<br />Life', pastoralDescription: 'Tools to support journeys, appointments and pastoral life.', openPastoral: 'Open Pastoral Life', footerTagline: 'Digital tools serving the Word.',
  },
  mg: {
